...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("Waiting for SD Card");
  ...
  PROGMEM Language_Str MSG_CONFIGURATION                   = _UxGT("Settings");
  ...
  #endif
  PROGMEM Language_Str MSG_PREHEAT_CUSTOM                  = _UxGT("Preheat");
  ...
  PROGMEM Language_Str MSG_NO_MEDIA                        = _UxGT("No SD Card");
